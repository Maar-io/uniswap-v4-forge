...
// forge script script/CreateETHpool.sol:CreateEthPoolScript --rpc-url $SEPOLIA_RPC --private-key $PRIVATE_KEY --broadcast --chain 11155111
...
contract CreateEthPoolScript is BaseScript, LiquidityHelpers {
    ...
    uint160 startingPrice = 1873855042454260090959041; // Precomputed: sqrtPriceX96 = uint160(sqrt(3500 * 1e18 / 1e6) * 2**96)

    // --- liquidity position configuration --- //
    uint256 public token0Amount = 1e18;
    uint256 public token1Amount = 3500e6;
    ...
    function _logInitialInfo() internal view {
        ...
        console2.log("Currency0 (ETH):", Currency.unwrap(currency0));
    ...
    function _checkBalances() internal view {
        ...
        uint256 balance0 = currency0.isAddressZero()
